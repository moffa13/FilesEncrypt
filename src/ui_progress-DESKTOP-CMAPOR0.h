...
public:
    ...
    void retranslateUi(QWidget *Progress)
    {
        ...
        speed->setText(QApplication::translate("Progress", "Vitesse : 0 o", 0));
        file_out_of->setText(QApplication::translate("Progress", "Fichier 0/0", 0));
        threads_n->setText(QApplication::translate("Progress", "Threads : 0", 0));
        pause_button->setText(QApplication::translate("Progress", "Pause", 0));
        cancel_button->setText(QApplication::translate("Progress", "Annuler", 0));
    } // retranslateUi
