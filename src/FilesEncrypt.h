...
public:
    ...
    static constexpr size_t VERSION_LENGTH = 1 + 5; // V00000
    static constexpr size_t SIZE_BEFORE_CONTENT = COMPARE_SIZE * 2 + AES_BLOCK_SIZE + VERSION_LENGTH + 1; // 1 is for the delimiter in versionning
...
private:
    ...
    static QString getEncryptBlob(const char* iv, quint32 version);
Q_SIGNALS:
